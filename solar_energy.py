...
labels = np.array(features['solarenergy'])
features= features.drop(['name', 'datetime', 'preciptype', 'snow', 'snowdepth', 'sunrise', 'sunset', 'conditions', 'description', 'icon', 'stations', 'solarenergy', 'cloudcover'], axis = 1)
